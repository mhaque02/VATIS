...
namespace VATIS.VoiceService {
    ...
    public partial class GetTranslationsResponse : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        //[System.Runtime.Serialization.OptionalFieldAttribute()]
        //private VoiceService.TranslationMatch[] TranslationsField;
        ...
        /*[System.Runtime.Serialization.DataMemberAttribute(EmitDefaultValue=false)]
        public VoiceService.TranslationMatch[] Translations {
            get {
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://api.microsofttranslator.com/V2", ConfigurationName="VoiceService.LanguageService")]
    public interface LanguageService {
        ...
        VoiceService.GetTranslationsResponse GetTranslations(string appId, string text, string from, string to, int maxTranslations, VoiceService.TranslateOptions options);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/AddTranslationArray", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/AddTranslationArrayResponse" +
            "")]
        void AddTranslationArray(string appId, VoiceService.Translation[] translations, string from, string to, VoiceService.TranslateOptions options);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/GetTranslationsArray", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/GetTranslationsArrayRespons" +
            "e")]
        VoiceService.GetTranslationsResponse[] GetTranslationsArray(string appId, string[] texts, string from, string to, int maxTranslations, VoiceService.TranslateOptions options);
        ...
        VoiceService.TranslateArrayResponse[] TranslateArray(string appId, string[] texts, string from, string to, VoiceService.TranslateOptions options);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface LanguageServiceChannel : VoiceService.LanguageService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class LanguageServiceClient : System.ServiceModel.ClientBase<VoiceService.LanguageService>, VoiceService.LanguageService {
        ...
        public VoiceService.GetTranslationsResponse GetTranslations(string appId, string text, string from, string to, int maxTranslations, VoiceService.TranslateOptions options) {
        ...
        public void AddTranslationArray(string appId, VoiceService.Translation[] translations, string from, string to, VoiceService.TranslateOptions options) {
            base.Channel.AddTranslationArray(appId, translations, from, to, options);
        }
        
        public VoiceService.GetTranslationsResponse[] GetTranslationsArray(string appId, string[] texts, string from, string to, int maxTranslations, VoiceService.TranslateOptions options) {
        ...
        public VoiceService.TranslateArrayResponse[] TranslateArray(string appId, string[] texts, string from, string to, VoiceService.TranslateOptions options) {
            return base.Channel.TranslateArray(appId, texts, from, to, options);
        }

        internal object Translate(string p, string p_2, string p_3, string p_4)
        {
